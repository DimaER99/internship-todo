<%@ Page Title="Todo" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebApplication1._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <h1>Список задач</h1>
        <asp:HiddenField runat="server" ID="hfSelectIndex" />
        <asp:Button ID="buttonAdd" runat="server" CssClass="btn btn-primary mb-2" OnClick="buttonAdd_click" Text="Добавить задачу" />
        <div>
